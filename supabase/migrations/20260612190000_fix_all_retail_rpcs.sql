-- ============================================
-- Migration: Fix Retail Stock RPCs
-- Date: 2026-06-12
-- ============================================

DROP FUNCTION IF EXISTS public.calculate_retail_system_stock_for_opname(DATE, TEXT);

-- Fix: calculate_retail_system_stock_for_opname return type
...
-- Redeploy GET functions to ensure they exist and have correct permissions
