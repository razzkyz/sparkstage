-- ============================================
-- Migration: Fix RPC get_order_and_tickets_by_order_number deleted_at error
-- Description: Removes oi.deleted_at IS NULL since order_items does not have a deleted_at column
-- ============================================
