-- =====================================================
-- Migration: Update list_inventory_product_page RPC
-- Created: 2026-06-20
-- Purpose: Add p_active_filter and p_department_filter to the RPC
--          so stock filters can be combined with status and department filters.
-- =====================================================

-- Drop the old function signature first to avoid overload ambiguity
DROP FUNCTION IF EXISTS public.list_inventory_product_page(text, text, text, integer, integer);
...
-- Force PostgREST schema reload to make the new function signature available
