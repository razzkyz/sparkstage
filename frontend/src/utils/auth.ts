...
import { ADMIN_MENU_SECTIONS, STARGUIDE_MENU_SECTIONS, CASHIER_MENU_SECTIONS, DRESSING_ROOM_ADMIN_MENU_SECTIONS, OWNER_MENU_SECTIONS, ROLLERBLADE_MENU_SECTIONS } from '../constants/adminMenu';
...
export const getMenuSectionsByRole = async (userId: string | undefined) => {
  ...
  if (result.ok && result.role === 'rollerblade') {
    return ROLLERBLADE_MENU_SECTIONS;
  }
