...
function DressingRoomProductEdit() {
  ...
  return (
    <AdminLayout
      ...
      title="Edit Produk"
      subtitle="Perbarui informasi produk sewa pakaian"
      onLogout={signOut}
    >
      <section className="space-y-6">
        ...
        <div className="flex items-center gap-3 rounded-xl border border-gray-200 bg-white p-4">
          ...
          <div>
            <h2 className="font-semibold text-gray-900">Edit Produk Sewa Pakaian</h2>
            <p className="text-sm text-gray-500">Perbarui informasi produk dan varian</p>
          </div>
        </div>
...
}export default DressingRoomProductEdit;
