...
const TERMS = [
  ...
  "Tiket berlaku bebas jam masuk — customer dapat hadir kapan saja selama jam operasional pada tanggal yang tertera di tiket.",
  "Durasi all day access untuk explore 13 stage selama jam operasional (09:00 - 17:30 WIB).",
  "Pengalaman di SPARK STAGE 55 berlangsung bersama peserta lain (sharing), bukan private session.",
    ...
    >
      ...
      <div
        style={{
          ...
          opacity: animate ? 1 : 0,
          transition:
            "transform 0.32s cubic-bezier(0.22,1,0.36,1), opacity 0.25s ease",
        }}
      ...
      >
        ...
        >
          ...
          <div
            style={{
              ...
              transition:
                "opacity 0.3s ease 0.08s, transform 0.35s cubic-bezier(0.22,1,0.36,1) 0.08s",
            }}
          >
            <img
              src={logoImage}
        ...
        >
          ...
          >
            ...
            >
              Saya telah membaca dan <strong>menyetujui</strong> seluruh
              ketentuan di atas.
            </span>
          </label>
