...
export default function CharmBar() {
  ...
  // Filter hanya produk Charm Bar dari tabel product_retail
  const products = useMemo(
    () => allProducts.filter((p) => p.retail_category === 'charmbar'),
    [allProducts],
  );
  ...
  // Sub-categories dari retail_categories relation (unique slugs)
                ...
                {subCategories.map((category) => {
                    ...
                    return (
                      <button
                        key={category.slug}
                        type="button"
                        onClick={() => setActiveCategory(isActive ? 'all' : category.slug)}
                      ...
                      >
                        ...
                        >
                          <div className="absolute inset-0 w-full h-full bg-gray-100 flex items-center justify-center">
                            <span className="material-symbols-outlined text-2xl text-gray-400">diamond</span>
                          </div>
                          {isActive && (
